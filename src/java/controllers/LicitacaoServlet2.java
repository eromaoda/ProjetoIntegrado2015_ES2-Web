...
import persistence.LicitacaoDAO2;

/**
 *
 * @author eduardo
 */
public class LicitacaoServlet2 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        LicitacaoDAO2 licitacaoDAO;
        //try{
            licitacaoDAO = new LicitacaoDAO2();
            listaLicitacaoBean = licitacaoDAO.getLicitacao(dominio, subdom, licitacao);
        ...
        dispatcher = request.getRequestDispatcher("./licitacao.jsp");
